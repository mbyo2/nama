-- Safe messages table migration with existing policy handling
...
DROP POLICY IF EXISTS "Members view own messages" ON public.messages;
...
DROP POLICY IF EXISTS "Members update read status" ON public.messages;
